    ...
    <div className="space-y-6">
            ...
            <table className="w-full text-sm text-left">
              <thead className="bg-slate-50 text-[10px] font-black uppercase text-slate-500 tracking-widest border-b">
                <tr>
                  ...
                  <th className="px-6 py-5">By Admin</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                {deletedUsers.map(u => (
                ...
                {deletedUsers.length === 0 && (
                  <tr><td colSpan={4} className="px-6 py-20 text-center text-slate-400 font-medium">No archived users found.</td></tr>
                )}
              </tbody>
            </table>
          ) : (
            <table className="w-full text-sm text-left">
              <thead className="bg-slate-50 text-[10px] font-black uppercase text-slate-500 tracking-widest border-b">
                <tr>
                  ...
                  <th className="px-6 py-5">Original Date</th>
                  <th className="px-6 py-5">Deleted At</th>
                  <th className="px-6 py-5">By Admin</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                ...
                {deletedDonations.length === 0 && (
                  <tr><td colSpan={5} className="px-6 py-20 text-center text-slate-400 font-medium">No archived donations found.</td></tr>
                )}
              </tbody>
            </table>
          )}
      ...
      <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl flex items-start gap-3">
        ...
        <p className="text-xs text-blue-700 leading-relaxed">
          <b>Note:</b> Data in the system archive is kept for auditing purposes. Records can only be permanently removed by a super-administrator using the database console.
        </p>
      </div>
    </div>
  );
